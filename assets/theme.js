...
/* ============================================================
   ...
   ============================================================ */
// Mobile Header Interactive Elements
document.addEventListener('DOMContentLoaded', function() {
  
  // Mobile Search Toggle
  const mobileSearchBtn = document.querySelector('.header--mobile .top-search-toggle');
  const mobileSearchForm = document.querySelector('.header--mobile #search-form');
  ...
  const mobileAccountBtn = document.querySelector('.header--mobile .account-toggle');
  const mobileAccountDropdown = document.querySelector('.header--mobile .account-dropdown');
  ...
  // Mobile Cart Sidebar
  const mobileCartBtn = document.querySelector('.header--mobile .cart-toggle');
  const cartSidebar = document.querySelector('.cart-drawer');
  const cartOverlay = document.querySelector('.bls__overlay');
  ...
  if (closeCartBtn || cartOverlay) {
    [closeCartBtn, cartOverlay].forEach(btn => {
      if (btn) {
  ...
  document.addEventListener('click', function(e) {
    if (!e.target.closest('.header--mobile')) {
      const activeDropdowns = document.querySelectorAll('.header--mobile .active');
